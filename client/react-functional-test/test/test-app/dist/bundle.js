...
var _reactWebdriver = __webpack_require__(27);
...
var root = _reactDom2.default.render(_react2.default.createElement(SimpleComponent, { text: 'hello world' }), document.getElementById('react-root'));

window.location.href.includes('noHooks') || (0, _reactWebdriver.addHooks)({ root: root, components: { SimpleComponent: SimpleComponent } });
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(8),B=__webpack_require__(2),C=__webpack_require__(1),ba=__webpack_require__(10),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(13),ia=__webpack_require__(14),D=__webpack_require__(4);
...
var TestUtils = __webpack_require__(28);
var ReactDOM = __webpack_require__(7);

module.exports = {

    executeAsyncWithError: function executeAsyncWithError(browser, f) {
        for (var _len = arguments.length, args = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
            args[_key - 2] = arguments[_key];
        }

        var a = browser.executeAsync.apply(browser, [f].concat(args));

        if (a.value !== null && _typeof(a.value) === 'object' && a.value.stack) {
            var e = new Error();
    ...
    findComponentsTest: function findComponentsTest(componentName) {
        return browser.execute(function (componentName) {
            return findComponentsBrowser(componentName).map(function (comp) {
                return comp.props;
            });
        }, componentName).value;
    },
    ...
    addHooks: function addHooks(hooks) {
        ...
        window.throwAsync = function (err, done) {
            done({
                name: err.name,
                stack: err.stack,
                message: err.message
        ...
        window.waitFor = function (fn, done) {
        ...
        window.findComponentsBrowser = function (componentName) {

            if (!(componentName in window.hooks.components)) {
                throw new Error(componentName + ' is not a component.');
            }

            return window.hooks.TestUtils.scryRenderedComponentsWithType(window.hooks.root, window.hooks.components[componentName]);
        };
    }
};
...
var f=__webpack_require__(2),h=__webpack_require__(3),m=__webpack_require__(7),n=__webpack_require__(1),p=__webpack_require__(8);
