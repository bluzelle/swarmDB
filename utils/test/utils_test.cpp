...
TEST(util_test, test_get_peer_info_request_encoding_short_params)
{
    // This is encoded for getNodeInfo(ARG1, ARG2) https://abi.hashex.org/
    const std::string ARG1 = "short1";
    const std::string ARG2 = "short2";
    std::string expected_data {
        ""
    };

    const auto data_str = bzn::utils::esr::data_string_for_get_peer_info(ARG1, ARG2);
    EXPECT_EQ(data_str, expected_data);
}

TEST(util_test, test_get_peer_info_request_encoding_mixed_length_params)
{
    const std::string LONG_ARG = "abcdefghijklmnopqrstuvwxyz0123456789";
    const std::string SHORT_ARG = "short";

    // This is encoded for getNodeInfo(LONG_ARG, SHORT_ARG)
    const std::string expected_data_1 {
        ""
    };

    // This is encoded for getNodeInfo(SHORT_ARG, LONG_ARG)
    std::string expected_data_2 {
        ""
    };

    const auto data_str_1 = bzn::utils::esr::data_string_for_get_peer_info(LONG_ARG, SHORT_ARG);
    EXPECT_EQ(data_str_1, expected_data_1);

    const auto data_str_2 = bzn::utils::esr::data_string_for_get_peer_info(SHORT_ARG, LONG_ARG);
    EXPECT_EQ(data_str_2, expected_data_2);
}

TEST(util_test, test_get_peer_info_request_encoding_long_params)
{
    // This is encoded for getNodeInfo(ARG1, ARG2) https://abi.hashex.org/
    const std::string ARG1 = "abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopqrstuvwxyz0123456789";
    const std::string ARG2 = "9876543210zyxwvutsrqponmlkjihgfedcba9876543210zyxwvutsrqponmlkjihgfedcba9876543210zyxwvutsrqponmlkjihgfedcba";
    std::string expected_data {
        ""
    };
