...
namespace bzn
{
    class raft_crud final : public bzn::deprecated::crud_base, public std::enable_shared_from_this<raft_crud>
    {
    public:
        raft_crud(std::shared_ptr<bzn::node_base> node, std::shared_ptr<bzn::raft_base> raft, std::shared_ptr<bzn::storage_base> storage, std::shared_ptr<bzn::subscription_manager_base> subscription_manager);
