...
raft_crud::raft_crud(std::shared_ptr<bzn::node_base> node, std::shared_ptr<bzn::raft_base> raft, std::shared_ptr<bzn::storage_base> storage, std::shared_ptr<bzn::subscription_manager_base> subscription_manager)
    : raft(std::move(raft))
    , node(std::move(node))
    ...
    std::call_once(this->start_once,
        [this]()
        {
            ...
            if (!this->node->register_for_message("database"
                                                  , std::bind(&raft_crud::handle_ws_crud_messages
                                                  , shared_from_this()
                                                  , std::placeholders::_1
                                                  , std::placeholders::_2)))
            {
...
void
raft_crud::do_raft_task_routing(const bzn::json_message& msg, const database_msg& request, database_response& response, std::shared_ptr<bzn::session_base> session)
{
...
void
raft_crud::handle_create(const bzn::json_message& msg, const database_msg& request, database_response& response)
{
...
void
raft_crud::handle_read(const bzn::json_message& /*msg*/, const database_msg& request, database_response& response)
{
...
void
raft_crud::handle_update(const bzn::json_message& msg, const database_msg& request, database_response& response)
{
...
void
raft_crud::handle_delete(const bzn::json_message& msg, const database_msg& request, database_response& response)
{
    if (this->raft->get_state() != bzn::raft_state::leader)
    {
        this->set_leader_info(response);
...
void
raft_crud::handle_get_keys(const bzn::json_message& /*msg*/, const database_msg& request, database_response& response)
{
...
void
raft_crud::handle_has(const bzn::json_message& /*msg*/, const database_msg& request, database_response& response)
{
...
void
raft_crud::handle_size(const bzn::json_message& /*msg*/, const database_msg& request, database_response& response)
{
    auto [keys, size] = this->storage->get_size(request.header().db_uuid());
...
void
raft_crud::handle_ws_crud_messages(const bzn::json_message& ws_msg, std::shared_ptr<bzn::session_base> session)
{
    bzn_msg msg;
...
void
raft_crud::do_follower_tasks(const bzn::json_message& msg, const database_msg& request, database_response& response)
{
    switch(request.msg_case())
    {
...
void
raft_crud::do_leader_tasks(const bzn::json_message& msg, const database_msg& request, database_response& response)
{
...
void
raft_crud::register_route_handlers()
{
    this->route_handlers[bzn::raft_state::leader]    = std::bind(&raft_crud::do_leader_tasks,    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->route_handlers[bzn::raft_state::candidate] = std::bind(&raft_crud::do_candidate_tasks, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->route_handlers[bzn::raft_state::follower]  = std::bind(&raft_crud::do_follower_tasks,  this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
}


void
raft_crud::register_command_handlers()
{
    ...
    this->command_handlers[database_msg::kCreate] = std::bind(&raft_crud::handle_create,   this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->command_handlers[database_msg::kRead]   = std::bind(&raft_crud::handle_read,     this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->command_handlers[database_msg::kUpdate] = std::bind(&raft_crud::handle_update,   this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->command_handlers[database_msg::kDelete] = std::bind(&raft_crud::handle_delete,   this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->command_handlers[database_msg::kKeys]   = std::bind(&raft_crud::handle_get_keys, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->command_handlers[database_msg::kHas]    = std::bind(&raft_crud::handle_has,      this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    this->command_handlers[database_msg::kSize]   = std::bind(&raft_crud::handle_size,     this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
}


void
raft_crud::register_commit_handlers()
{
    ...
    this->commit_handlers[database_msg::kCreate] = std::bind(&raft_crud::commit_create, this, std::placeholders::_1);
    this->commit_handlers[database_msg::kUpdate] = std::bind(&raft_crud::commit_update, this, std::placeholders::_1);
    this->commit_handlers[database_msg::kDelete] = std::bind(&raft_crud::commit_delete, this, std::placeholders::_1);
}


void
raft_crud::set_leader_info(database_response& msg)
{
